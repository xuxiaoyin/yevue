              ...
              <div class="seach">
                <div class="seach_input">
                  <div class="left"  @click="show_cat">
                    ...
                    <div class="search_item" v-show="search_item" >
                          <ul id="search_item">
                            <li v-for="(item,index) in fenlei" @click="change_cat(index)"><a href="javascript:void(0);">{{item.cat_name}}</a></li>
                              
                          </ul>
                      </div>
                  </div>
                  <div class="center"><input type="text" v-model="kewords" placeholder="请输入搜索关键字" value="" @keyup.enter="seach_input" /></div>
                ...
                <div class="seach_keyword">
                  ...
                  <div class="label_list">
                    <ul>
                      <li v-for="item in search_keyword[0].split('，')" @click="get_key(item)">{{item}}</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="container" style="width:1300px;">
              <ul>
                <li v-for="(item,index) in nav_list" 
                    ...
                    @click="go_url(item.url,index)" @mouseover="go_url1(item,item.url,index)"><a href="javascript:void(0);">{{item.name}}</a></li>
...
export default {
     ...
     methods:{
      get_key(key){
        ...
        go_url1(item,url,index){
          console.log("url:"+index+item.name)
          if(item.name==="咨询频道"){
            this.$router.replace({path:url})
            this.tab_num = index
          }
