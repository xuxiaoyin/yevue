                ...
                <div class="container">
                    ...
                    <div class="page">
                         <el-pagination
                          ...
                          :page-size="20"
                          :page-count="parseInt(data_info.yeshu)"
...
<script>
    ...
    export default {
        ...
        watch: {
              ...
              pjtid() {
                this.change_attr(0,this.$route.query.id,this.$route.query.attr_id)
              },
        },
        methods:{
            ...
            get_list(page,id){
                ...
                this.$axios({
                    url:'http://cy.gzziyu.com/mobile/category.php?id=1&Action=yemian',
                    method:'post',
                    params:{
                        brand:id,
                        page:page,
            ...
            go_detail(id){
                this.$router.push({path:'/hangqing_detail',query:{id:id}})
               
            },
            get_liulan(){
               
                this.$axios({
                   url:'https://cy.gzziyu.com/mobile/ziyu.php?Action=youlanjilv&shuzi=1',
                   method:'post',
